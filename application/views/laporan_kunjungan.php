            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="panel panel-primary">
                ...
                <div class="panel-body"><!-- Panel-body-->
                  <div class="row">
                    <form action="<?php echo base_url('welcome/laporan_kunjungan/'.$tipe);?>" method="POST">
                      <div class="col-lg-12">
                  ...
                  <div class="col-sm-12">
                    <a href="<?php echo base_url('welcome/print_laporan/'.$tipe.'/'.$id_unit.'/'.$date_first.'/'.$date_last); ?>" target="_blank"><button type="button" name="print" class="btn btn-primary pull-right m-l-10">Print</button></a>
                  </div>
