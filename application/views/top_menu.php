<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="<?php echo base_url('welcome'); ?>" class="logo"><img src="<?php echo base_url('assets/img/logo/logo DKI.png');?>" class="thumb-md"><span> R.B.com</span></a>
        </div>
    </div>
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo site_url('welcome/profile');?>"><i class="fa fa-user"></i> Profile</a></li>
